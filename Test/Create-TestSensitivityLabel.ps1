...
$LogFile = Join-Path $LogPath 'Create-TestSensitivityLabel.log'
...
# =========================================================================
# 1) TEST-PUBLIC - muss vor allen anderen Labels erstellt werden
# =========================================================================
$publicLabel = @{
	Name                               = 'Test-Public'
...
# =========================================================================
$groupLabels = @(
	[pscustomobject]@{ Name = 'Test-General';              DisplayName = 'Test-General';              Tooltip = 'Für allgemeine Informationen und Angelegenheiten.' },
	[pscustomobject]@{ Name = 'Test-Confidential';          DisplayName = 'Test-Confidential';          Tooltip = 'Für vertrauliche Informationen und Angelegenheiten.' },
	[pscustomobject]@{ Name = 'Test-Strictly-Confidential'; DisplayName = 'Test-Strictly Confidential'; Tooltip = 'Für streng vertrauliche Informationen und Angelegenheiten.' }
)
...
$subLabels = @(
	[pscustomobject]@{ Name = 'Test-General-Intern';                     DisplayName = 'Test-Intern';      Tooltip = 'Allgemeine interne Belange.';                                 ParentName = 'Test-General';              FooterText = 'General Intern';                     FooterColor = '#0000FF'; ProtectionType = 'RemoveProtection' },
	[pscustomobject]@{ Name = 'Test-General-Extern';                     DisplayName = 'Test-Extern';      Tooltip = 'Allgemeine externe Belange.';                                 ParentName = 'Test-General';              FooterText = 'General Extern';                     FooterColor = '#0000FF'; ProtectionType = 'RemoveProtection' },
	[pscustomobject]@{ Name = 'Test-Confidential-Intern';                DisplayName = 'Test-Intern';      Tooltip = 'Vertrauliche interne Belange.';                               ParentName = 'Test-Confidential';         FooterText = 'Confidential Intern';                FooterColor = '#FFFF00'; ProtectionType = 'RemoveProtection' },
	[pscustomobject]@{ Name = 'Test-Confidential-Extern';                DisplayName = 'Test-Extern';      Tooltip = 'Vertrauliche externe Belange.';                               ParentName = 'Test-Confidential';         FooterText = 'Confidential Extern';                FooterColor = '#FFFF00'; ProtectionType = 'RemoveProtection' },
	[pscustomobject]@{ Name = 'Test-Confidential-Legal';                 DisplayName = 'Test-Legal';       Tooltip = 'Vertrauliche Rechtsangelegenheiten.';                         ParentName = 'Test-Confidential';         FooterText = 'Confidential Legal';                 FooterColor = '#FFFF00'; ProtectionType = 'Template'; RightsDefinitions = "$LegalIdentity`:VIEW, VIEWRIGHTSDATA,DOCEDIT,EDIT,PRINT,EXTRACT,REPLY,REPLYALL,FORWARD,EDITRIGHTSDATA,EXPORT,OBJMODEL,OWNER;$LeadershipIdentity`:VIEW,VIEWRIGHTSDATA,OBJMODEL"; OfflineAccessDays = 0 },
	[pscustomobject]@{ Name = 'Test-Confidential-Finance';               DisplayName = 'Test-Finance';     Tooltip = 'Vertrauliche Belange der Finanzabteilung.';                   ParentName = 'Test-Confidential';         FooterText = 'Confidential Finance';               FooterColor = '#FFFF00'; ProtectionType = 'Template'; RightsDefinitions = "$FinanceIdentity`:VIEW, VIEWRIGHTSDATA,DOCEDIT,EDIT,PRINT,EXTRACT,REPLY,REPLYALL,FORWARD,EDITRIGHTSDATA,EXPORT,OBJMODEL,OWNER;$LeadershipIdentity`:VIEW,VIEWRIGHTSDATA,OBJMODEL"; OfflineAccessDays = 0 },
	[pscustomobject]@{ Name = 'Test-Strictly-Confidential-Intern';       DisplayName = 'Test-Intern';      Tooltip = 'Streng vertrauliche interne Belange.';                        ParentName = 'Test-Strictly-Confidential'; FooterText = 'Strictly Confidential Intern';       FooterColor = '#FF0000'; ProtectionType = 'Template'; RightsDefinitions = "$LeadershipIdentity`:VIEW, VIEWRIGHTSDATA,DOCEDIT,EDIT,PRINT,EXTRACT,REPLY,REPLYALL,FORWARD,EDITRIGHTSDATA,EXPORT,OBJMODEL,OWNER"; OfflineAccessDays = 0 },
	[pscustomobject]@{ Name = 'Test-Strictly-Confidential-Personalized'; DisplayName = 'Test-Personalized'; Tooltip = 'Streng vertrauliche personalisierte Belange.';                ParentName = 'Test-Strictly-Confidential'; FooterText = 'Strictly Confidential Personalized'; FooterColor = '#FF0000'; ProtectionType = 'UserDefined' }
)
